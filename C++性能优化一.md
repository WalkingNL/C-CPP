## 前言
今年一直在对我们系统前后台的代码及性能做优化，感受颇深。我不知道是不是自己的错觉，想着有了框架的加持，代码就会整洁，维护起来，总之不会显得那么杂乱。但我见到的情况，似乎违背这个“常理”了。似乎成了这样，正因为有了框架，大家写代码反而是为所欲为。这些就不在这里说了，有机会专门讨论。接下来，我会把在工作中，遇到的可能的优化点，都写出来。也算是对于这些日工作的总结。涉及到的点有以下几个
  * 临时对象
  * 内联函数
  * 排序
  * 内存池
